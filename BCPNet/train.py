...
def train(train_loader, model, optimizer, epoch, total_step, opt, log_file, global_step):
    ...
    if (epoch + 1) % 1 == 0 or (epoch + 1) == opt.epoch:
        ckpt_path = save_path + 'BCPNet-%d.pth' % epoch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_save', type=str, default='BCPNet_DINOv2_CGCOD_tokennew_text')
    ...
    parser.add_argument(
        '--train_text_root',
        type=str,
        default='./data/text_tokens/train',
    ...
    parser.add_argument('--swanlab_project', type=str, default='BCPNet-COD', help='SwanLab project name')
    parser.add_argument(
        '--swanlab_exp_name',
        type=str,
        default='BCPNet_DINOv2_CGCOD_token_text',
